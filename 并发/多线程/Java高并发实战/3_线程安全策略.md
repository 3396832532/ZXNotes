...
![1556785742022](assets/1556785742022.png)
...
使用容器时，如果使用`foreach`或者`iterator`遍历的时候，又想删除某个元素，就可能会抛出这个异常:
...
具体原因可以参考这篇博客: <https://www.cnblogs.com/dolphin0520/p/3933551.html>
